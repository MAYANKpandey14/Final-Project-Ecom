...
export default function Checkout() {
  ...
  const [isCryptoOrderProcessing, setIsCryptoOrderProcessing] = useState(false);
  const [cryptoOrderSuccess, setCryptoOrderSuccess] = useState(false);
  ...
  const handleCryptoCheckout = async () => {
    ...
    try {
      ...
      setIsCryptoOrderProcessing(true);
  ...
  if (orderSuccess || cryptoOrderSuccess) {
    return (
  ...
  if (isOrderProcessing || isCryptoOrderProcessing) {
    return (
      <div className="w-full min-h-screen flex justify-center items-center">
        <PulseLoader
          color={"#000000"}
          loading={isOrderProcessing || isCryptoOrderProcessing}
          size={30}
          data-testid="loader"
        />
      </div>
        ...
        <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
                ...
                <div
                  ...
                  className={`border p-6 rounded-md ${
                    item._id === selectedAddress
                      ? "border-blue-800 border-2 ease-in duration-100"
                      : ""
                  }`}
                >
          ...
          <div className="mt-6 border-t border-b py-2">
            ...
            <div className="flex flex-col">
              {errorMessage && (
                <p className="font-semibold my-4 text-red-600">
                  {errorMessage}
                </p>
              )}
              <button
