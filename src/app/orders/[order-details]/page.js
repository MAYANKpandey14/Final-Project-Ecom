    ...
    <div className=" py-14 px-4 md:px-6">
      ...
      <div className="mt-10 flex flex-col justify-center xl:flex-row items-stretch w-full xl:space-x-8 md:space-y-6 xl:space-y-0">
        <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
          <div className="flex flex-col rounded-md drop-shadow-lg justify-start items-start bg-gray-100 px-4 py-4 md:p-6 xl:p-8 w-full">
          ...
          <div className="flex justify-center flex-col md:flex-row items-stretch w-full space-y-4 md:space-y-0 md:space-x-5 xl:space-x-8">
            <div className="flex flex-col px-4 py-6 rounded-md drop-shadow-lg md:p-6 xl:p-8 w-full bg-gray-100 space-y-6">
              <h3 className="text-xl font-semibold leading-6 text-gray-900">
                Summary
              </h3>
              <div className="flex justify-center items-center w-full space-y-4 flex-col border-gray-300 border-b-2 pb-4">
                ...
                <div className="flex justify-between w-full">
                  <p className="text-base leading-5 text-gray-800">Subtotal</p>
                  <p className="text-xl font-bold leading-5 text-gray-900">
                    ${orderDetails && orderDetails.totalPrice}
                  </p>
                </div>
              </div>
        ...
        <div className="flex flex-col gap-5">
          <div className="bg-gray-100 rounded-md drop-shadow-lg w-full xl:w-96 flex  items-center md:items-start px-4 py-6 flex-col">
            <h3 className="text-xl font-semibold leading-6 text-gray-900">
              Customer Details
            </h3>
            <div className="flex flex-col justify-start items-start flex-shrink-0">
              <div className="flex gap-4 justify-center flex-col w-full md:justify-start py-8 ">
                <p className="text-base font-medium leading-4 text-left text-gray-950">
                  Name: {user?.name}
                </p>
                <p className="text-base font-medium leading-4 text-left text-gray-950">
                  Email: {user?.email}
          ...
          <button
            onClick={() => router.push(`/`)}
            className="mt-5 mr-5  inline-block bg-black text-white px-5 py-3 text-md font-medium rounded-md tracking-wide border-2 border-black hover:bg-white hover:text-black ease-in-out duration-300"
          >
            Shop Again
          </button>
        </div>
